...
save_figure_location = '/Users/stephenholtz/local_experiment_copies/figures/unilat_windowed_prog_reg_grats_w_flicker';
...
for stim_lam = {'4_px','12_px'}
    ...
    figure_file_prefix = [stimulus_lambda '_prog_reg_stims'];
    font_color = [0 0 0];
    xy_color = [0 0 0];
    ...
    font_size_1 = 7;
    font_size_2 = 10;
    default_colors = [0 0 1 ; 1 0 0 ; 0 .5 0];
    ...
    for window_size = 1:2
        ...
        for stim_ind = stim_inds
            ...
            stim_type_iter = 1;
            for stim_type = {['flicker_' stimulus_lambda '_right'],['prog_' stimulus_lambda '_cw'],['prog_' stimulus_lambda '_cw_w_flicker'],['reg_' stimulus_lambda '_cw'],['reg_' stimulus_lambda '_cw_w_flicker']}
    ...
    meta_str = [{['Prog / Reg Stimuli (with flicker) - ' num2str(summ_data.(stim_type_str)(exp_grp_num).info.pix(stim_inds(1))) ' Pix High']},...
